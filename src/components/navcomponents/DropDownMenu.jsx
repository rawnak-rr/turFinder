...
const DropdownMenu = ({ isMenuOpen, toggleMenu, handleMenuItemClick }) => (
  <>
    <div
      className={`fixed top-0 z-50 left-1/2 -translate-x-1/2 -translate-y-1/2
        w-11/12 max-w-md bg-darkgreen/90 backdrop-blur-md rounded-2xl p-8
      ...
      <button
        onClick={toggleMenu}
        className="absolute top-3 right-4 text-beige hover:text-yellow text-lg font-redhatmono duration-200">
        close
      </button>
    </div>
